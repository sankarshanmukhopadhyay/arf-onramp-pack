...
- [ ] confirm the project uses the current canonical ARF and STS repositories
...
- [ ] assess whether onboarding assumptions need revision in light of CIR (EU) 2026/798
- [ ] identify enrollment, LoA, or identity-binding changes that affect implementation or local evidence plans
